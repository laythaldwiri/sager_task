    ...
    <div class="content-wrapper">
        <div class="content">
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.customers-index') }}">
                                    <span class="fa fa-th"></span> All Users
                                </a>
                            </li>
                ...
                {{-- =================== Body ===================== --}}
                {{-- ============================================== --}}
                <div class="content-wrapper customer-form">
                    <div class="content">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    {{-- Form Section --}}
                                    <div class="card-body">
                                        <form id="createForm" action="{{ route('super_admin.customers-store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-row">

                                                {{-- Name --}}
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3" for="store_name"> Name :
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name" class="form-control" @error('name') is-invalid @enderror placeholder="Name" value="{!! old('name') ? old('name') : null !!}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" name="email" class="form-control" @error('email') is-invalid @enderror id="validationServer01" placeholder="Email" value="{!! old('email') ? old('email') : null !!}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Password :
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select name="status" class="custom-select my-1 mr-sm-2 @error('status') is-invalid @enderror">
